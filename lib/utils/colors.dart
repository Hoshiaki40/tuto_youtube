...
class AppColors {
  ...
  static final Color SelectionBackground = Color(0xC3858527);
  static final Color mainSelectionBackground2 = const Color(0xFFCC0020);
  static final Color mainSelectionBackground3 = const Color(0x61616150);
